...
export function createWebpackConfig(
  ...
  return function webpackConfig(config: Configuration, { defaultLoaders }): Configuration {
...
export function prepareConfig(
  ...
  const config = withSTYLUS(withSASS(withLESS(withCSS(loadConfig(phase, projectRoot, null)))));
  ...
  config.webpack = (a, b) =>
    createWebpackConfig(workspaceRoot, projectRoot, fileReplacements)(userWebpack(a, b), b);
  return config;
}
